...
- remaining gate: the full G5 normal Research Authoring child replay must be rerun against the new candidate before G5 can close. The previous one-time replay authorization was consumed by the diagnostic replay above, so no further child replay has been run under this repair.
