...
For manuscript figures, top-conference plots, poster figure palettes, or
publication color QA, route figure styling to `scientific-visualization`. That
plugin owns the canonical palette library, plotting snippets, gallery, and
publication figure presets; this skill owns venue/template requirements.
