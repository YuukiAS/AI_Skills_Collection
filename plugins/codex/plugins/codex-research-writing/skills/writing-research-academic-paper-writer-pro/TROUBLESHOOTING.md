...
*   Use example values in your draft like `[INSERT FIGURE 1 HERE]`.
*   Explicitly tell the Agent: "Insert `figures/fig1.png` at the example value [INSERT FIGURE 1 HERE] with width 8cm."
