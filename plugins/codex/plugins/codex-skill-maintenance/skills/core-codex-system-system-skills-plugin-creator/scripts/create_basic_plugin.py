...
DEFAULT_MARKETPLACE_DISPLAY_NAME = "[example: Marketplace Display Name]"
...
def build_plugin_json(plugin_name: str) -> dict:
    return {
        ...
        "description": "[example: Brief plugin description]",
        "author": {
            "name": "[example: Author Name]",
            "email": "[example: author@example.com]",
            "url": "[example: https://github.com/author]",
        },
        "homepage": "[example: https://docs.example.com/plugin]",
        "repository": "[example: https://github.com/author/plugin]",
        "license": "[example: MIT]",
        "keywords": ["[example: keyword1]", "[example: keyword2]"],
        "skills": "[example: ./skills/]",
        "hooks": "[example: ./hooks.json]",
        "mcpServers": "[example: ./.mcp.json]",
        "apps": "[example: ./.app.json]",
        "interface": {
            "displayName": "[example: Plugin Display Name]",
            "shortDescription": "[example: Short description for subtitle]",
            "longDescription": "[example: Long description for details page]",
            "developerName": "[example: OpenAI]",
            "category": "[example: Productivity]",
            "capabilities": ["[example: Interactive]", "[example: Write]"],
            "websiteURL": "[example: https://openai.com/]",
            "privacyPolicyURL": "[example: https://openai.com/policies/row-privacy-policy/]",
            "termsOfServiceURL": "[example: https://openai.com/policies/row-terms-of-use/]",
            "defaultPrompt": [
                "[example: Summarize my inbox and draft replies for me.]",
                "[example: Find open bugs and turn them into tickets.]",
                "[example: Review today's meetings and flag gaps.]",
            ],
            "brandColor": "[example: #3B82F6]",
            "composerIcon": "[example: ./assets/icon.png]",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Create a plugin skeleton with example value plugin.json."
    )
    ...
    parser.add_argument("--with-mcp", action="store_true", help="Create .mcp.json example value")
    parser.add_argument("--with-apps", action="store_true", help="Create .app.json example value")
    parser.add_argument(
        "--with-marketplace",
        action="store_true",
        help=(
