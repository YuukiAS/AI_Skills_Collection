...
- If there is little or no citable support, write a useful generic draft with example values or clearly labeled assumptions rather than unsupported specifics.
```
