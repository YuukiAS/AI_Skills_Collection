#!/usr/bin/env python3
"""Build the Bridge Kit visual input manifest for the statistical benchmark."""
...
FIXTURE_ROOT = REPO_ROOT / "tests" / "fixtures" / "presentations" / "statistical_method_group_meeting"
PACKET_SOURCE = FIXTURE_ROOT / "visual_review_packet_source"
DEFAULT_TASK_KEY = "016_statistical_method_group_meeting_benchmark"
BRIDGE_KIT_COMMIT = "6968a84b689d6e5589d068aee7dd101b12fd7700"
...
def build_manifest(source_dir: Path, task_key: str) -> dict[str, Any]:
    ...
    return {
        ...
        "identity_bindings": {
            ...
            "pdf_sha256": sha256(source_dir / "pdf" / "statistical_method_group_meeting_benchmark.pdf"),
            "pptx_sha256": sha256(source_dir / "statistical_method_group_meeting_benchmark.pptx"),
        ...
        "review_kind": "statistical-method-group-meeting-benchmark",
        "rubric": {
