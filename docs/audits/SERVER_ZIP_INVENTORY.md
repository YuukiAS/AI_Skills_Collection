...
| File | SHA256 | Classification | v3.1 handling |
|---|---|---|---|
| `skills-CUHK.zip` | `95AC905AC8DABA9FC0FF401777F1197612635764C020F33FC80E813EEE186B3D` | local user-provided server skill bundle | Kept as tracked input for GPT v3 refactor review; generic Slurm behavior merged into `skills/tools/hpc/slurm-workflows/`; public site constraints recorded in `site-profiles/cuhk-central-cluster.json`. |
| `skills-UNC.zip` | `0DA4862079F2F494132669682CAEC9450904EC72817FF6C156424A5B4C035A8C` | local user-provided server skill bundle | Kept as tracked input for GPT v3 refactor review; generic Slurm behavior merged into `skills/tools/hpc/slurm-workflows/`; public site constraints recorded in `site-profiles/unc-longleaf.json`. |
