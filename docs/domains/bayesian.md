...
```bash
python3 scripts/skills.py install --target repo --skill domain/bayesian/bayesian-ppl-diagnostics --skill domain/bayesian/pymc --skill domain/bayesian/simpy --mode symlink --write-agents-md
```
