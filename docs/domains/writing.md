...
```bash
ai-skills install --target repo --skill writing/research/academic-paper-writer-pro --skill writing/core/chinese-prose --skill writing/research/content-generation --mode symlink --write-agents-md
```
