...
```bash
ai-skills install --target repo --skill writing/research/academic-paper-writer-pro --skill writing/research/content-generation --skill writing/research/literature-review --mode symlink --write-agents-md
```
