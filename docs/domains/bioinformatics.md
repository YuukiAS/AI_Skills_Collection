...
```bash
ai-skills install --target repo --skill domain/bioinformatics/anndata --skill domain/bioinformatics/arboreto --skill domain/bioinformatics/bioinformatics-database-retrieval --mode symlink --write-agents-md
```
